                ...
                <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50">
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center gap-2">
                      <div className={`w-3 h-3 rounded-full ${routeData.departurePointId ? 'bg-orange-500' : 'bg-gray-300 dark:bg-gray-600'
                        }`} />
                    ...
                    <div className="flex items-center gap-2">
                      <div className={`w-3 h-3 rounded-full ${routeData.arrivalPointId ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600'
                        }`} />
